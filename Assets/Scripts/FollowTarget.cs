...
public class FollowTarget : MonoBehaviour
{
    ...
    //public Transform PapanScore;
    //public Transform PapanLevel;
    ...
    void Update()
    {
        ...
        //PapanScore.transform.position = new Vector2(transform.position.x * 1.0f, PapanScore.transform.position.y);
        //PapanLevel.transform.position = new Vector2(transform.position.x * 1.0f, PapanLevel.transform.position.y);
